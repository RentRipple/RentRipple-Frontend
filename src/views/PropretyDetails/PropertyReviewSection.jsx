...
import { Button, TextField, Rating, Grid, Card, CardContent, Typography } from '@mui/material';
...
const PropertyReviewSection = ({ propertyId, isOwner }) => {
    const { fetchReviewsByProperty, addReview, reviews } = useContext(PropertyContext);
            ...
            {userId && !isOwner && (
                <ReviewFormContainer>
                    <form onSubmit={handleSubmit}>
                        ...
                        <Button type="submit" variant="contained" style={{ marginTop: '10px', backgroundColor: "#04c4cc", color: "white" }}>
                            Submit
                        </Button>
                    </form>
                </ReviewFormContainer>
